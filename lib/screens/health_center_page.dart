...
class HealthCenterPage extends StatefulWidget {
  @override
  _HealthCenterPageState createState() => _HealthCenterPageState();
}
      ...
      builder: (context, snapshot) {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            // ตรวจสอบว่า type เป็นร้านขายยา
            if (data['type'] == 'สถานีอนามัย') {
              return Card(
...
class _HealthCenterPageState extends State<HealthCenterPage> {
  ...
  int _currentIndex = 3; // ค่าเริ่มต้นที่หน้าหลัก
...
// ✅ ตรวจสอบว่าผู้ใช้เป็น "ผู้เยี่ยมชม"
      ...
      body:_currentIndex == 3 // ตรวจสอบว่าหน้าปัจจุบันเป็นหน้าหลักหรือไม่
          ? Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Padding(
            ...
            child: Text(
              'สถานีอนามัยที่รองรับบัตรทองในจังหวัดพระนครศรีอยุธยา',
              style: TextStyle(
                fontSize: 28,
          ...
          Expanded(
            child: _currentPosition == null
              ...
              stream: FirebaseFirestore.instance
                  .collection('locations')
                  .where('type', isEqualTo: 'สถานีอนามัย') // กรองเฉพาะสถานีอนามัย
                  .snapshots(),
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  return Center(child: CircularProgressIndicator());
                ...
                if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                  return Center(child: Text('ไม่มีข้อมูลสถานีอนามัย'));
                }
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final doc =
                    sortedDocuments[index]['doc'] as QueryDocumentSnapshot;
