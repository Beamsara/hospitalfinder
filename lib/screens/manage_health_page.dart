...
class LocationSearchDelegate extends SearchDelegate<String> {
  ...
  void _showSuccessAlertConfirm(BuildContext context) {
    showDialog(
      context: context,
          ...
          itemBuilder: (context, index) {
            ...
            switch (data['type']) {
              ...
              case 'สถานีอนามัย':
                ...
                break;
              default:
                iconData = Icons.location_on; // ไอคอนเริ่มต้นหากไม่มีประเภท
            }
            ...
            return Card(
              ...
              child: ListTile(
                ...
                leading: Container(
                  ...
                  child: Icon(
                    iconData, // ✅ ใช้ไอคอนที่กำหนดตามประเภท
                    color: Colors.white,
                    size: 24,
                  ),
                ),
                ...
                trailing: Row(
                  ...
                  children: [
                    ...
                    // ✅ ปุ่ม "กดเพื่อยืนยัน" พร้อม Gradient และ Dialog ยืนยัน
                    if (data['userId'] == null)
                      GestureDetector(
                        onTap: () {
                          showDialog(
                            ...
                            builder: (context) => AlertDialog(
                              ...
                              content: Text('คุณต้องการอนุมัติสถานพยาบาลนี้หรือไม่?'),
                              actions: [
                                TextButton(
                                  onPressed: () {
                                ...
                                ElevatedButton(
                                  onPressed: () async {
                                    ...
                                    Navigator.pop(context);
                                    _showSuccessAlertConfirm(context); // แสดงการยืนยันสำเร็จ
                                  },
                                  style: ElevatedButton.styleFrom(
            ...
            // ถ้า type ไม่ใช่ 'ร้านขายยา' ให้คืนค่าเป็น Container ว่าง
            return Container();
          },
        );
  ...
  Future<void> _showPinDetailsDialog(BuildContext context, DocumentSnapshot doc) async {
    ...
    if (currentUserId != null) {
      ...
      role = userDoc.data()?['role'] ?? 'user'; // ค่าเริ่มต้นเป็น 'user' ถ้าไม่มีข้อมูล
    }
    ...
    showDialog(
      ...
      builder: (context) => Dialog(
        ...
        child: SizedBox(
          ...
          height: MediaQuery.of(context).size.height * 0.5, // ตั้งค่าความสูง
          child: Padding(
...
class _ManageHealthPageState extends State<ManageHealthPage> {
  ...
  String? _selectedType; // กรองตามประเภท
  bool _sortByDistance = false; // เรียงลำดับตามระยะทาง
  ...
  int _currentIndex = 2; // ค่าเริ่มต้นที่หน้าหลัก
...
// ✅ ตรวจสอบว่าผู้ใช้เป็น "ผู้เยี่ยมชม"
      ...
      body:_currentIndex == 2 // ตรวจสอบว่าหน้าปัจจุบันเป็นหน้าหลักหรือไม่
          ? Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Padding(
            ...
            child: Text(
              'จัดการสถานพยาบาลที่รองรับบัตรทองในจังหวัดพระนครศรีอยุธยา',
              style: TextStyle(
                fontSize: 28,
          ...
          /// ✅ **เพิ่มฟีเจอร์กรองประเภทและเรียงตามระยะ**
          Padding(
            ...
            child: Row(
              children: [
                ...
                ElevatedButton.icon(
                  ...
                  label: Text(
                    _sortByDistance ? "ไกล → ใกล้" : "ใกล้ → ไกล",
                  ),
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.teal,
          ...
          /// ✅ **แก้ไขส่วน StreamBuilder ให้รองรับฟิลเตอร์**
          Expanded(
            child: _currentPosition == null
              ...
              builder: (context, snapshot) {
                ...
                var documents = snapshot.data!.docs.map((doc) {
                  ...
                  return {'doc': doc, 'data': data, 'distance': distance};
                }).toList();
                ...
                if (_selectedType != null) {
                  documents = documents
                      .where((e) {
                    final data = e['data'] as Map<String, dynamic>?; // ✅ Cast ก่อน
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final doc = documents[index]['doc'] as QueryDocumentSnapshot;
                    final data = documents[index]['data'] as Map<String, dynamic>;
                    final distance = documents[index]['distance'] as double;
                    final currentUserId = FirebaseAuth.instance.currentUser?.uid;
                    ...
                    return Card(
                      ...
                      child: ListTile(
                                      ...
                                      actions: [
                                        ...
                                        ElevatedButton(
                                          onPressed: () async {
                                            ...
                                            Navigator.pop(context);
                                            _showSuccessAlertConfirm(); // แสดงการยืนยันสำเร็จ
                                          },
                                          style: ElevatedButton.styleFrom(
                                            backgroundColor: Colors.transparent,
                                            shadowColor: Colors.transparent,
                        ...
                        onTap: () {
                          _showPinDetailsDialog(context, documents[index]['doc'] as DocumentSnapshot);
                        },
                      ),
                    );
                  },
